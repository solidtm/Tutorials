...
public interface PRNG {
    ...
    int nextInt(int upperBound, int lowerBound) throws PRNGException; // returns the next random value with lowerBound as lower bound and upperBound as upper bound
